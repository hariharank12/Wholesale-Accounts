...
public class WholesaleAccountsExceptionHandler extends
        ResponseEntityExceptionHandler {

    @ExceptionHandler(ResourceNotFoundException.class)
    public ResponseEntity<?> handleResourceNotFound(
            ResourceNotFoundException resourceNotFoundException) {
        GlobalError globalError = new GlobalError(resourceNotFoundException
                .getMessage(),
    ...
    public ResponseEntity<?> handleInvalidRequest(
        ...
        GlobalError globalError = new GlobalError(invalidRequestException
                .getMessage(),
